...
if __name__ == "__main__":
    edl_file = input("Enter the path to the MPV EDL file: ")
    srt_file = input("Enter the path to the SRT subtitle file: ")
    output_edl_file = input("Enter the desired path for the new EDL file: ")
